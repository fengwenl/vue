<template>
  <div>
    ...
    <book-list :book-type="bookType" ref="updateList"></book-list>
     <mvpage></mvpage>
  </div>
</template>
  ...
  export default{
    ...
    '$route'(to, from){
        ...
        if (to.path.indexOf('/bks/') == 0) {
          ...
          this.$refs.updateList.searchBook(obj);
        }
      }
    },
    components: {
